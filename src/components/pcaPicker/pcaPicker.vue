...
<script>
	...
	export default {
		...
		mounted() {
			...
			// this.data.province ? this.pcaArr[this.pcaIndex[0]].name = this.data.province : null
			//  this.data.city ?this.pcaArr[this.pcaIndex[0]].children[this.pcaIndex[1]].name = this.data.city : null
			// this.data.area ? this.pcaArr[this.pcaIndex[0]].children[this.pcaIndex[1]].children[this.pcaIndex[2]].name = this.data.area : null
		},
		methods: {
			// 防穿透
			preventTouchMove() {},
			...
			// 确认
			confirm(e) {
				let current = this.pcaArr[this.pcaIndex[0]].name + '' + this.pcaArr[this.pcaIndex[0]].children[this
					.pcaIndex[1]].name + '' + this.pcaArr[this.pcaIndex[0]].children[this.pcaIndex[1]].children[this
					.pcaIndex[2]].name;
				this.$emit('confirm', {
					province: this.pcaArr[this.pcaIndex[0]].name,
					city: this.pcaArr[this.pcaIndex[0]].children[this.pcaIndex[1]].name,
					area: this.pcaArr[this.pcaIndex[0]].children[this.pcaIndex[1]].children[this.pcaIndex[2]].name,
					address: current
				})
				this.hide();
			},
